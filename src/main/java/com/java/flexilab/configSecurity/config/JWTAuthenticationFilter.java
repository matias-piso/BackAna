...
import com.java.flexilab.configSecurity.model.UserLogin;
import com.java.flexilab.configSecurity.service.UserDetailsImpl;
import com.java.flexilab.utils.ErrorResponse;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        ...
        try {
            ...
            usuarioLogin = new ObjectMapper().readValue(request.getReader(), UserLogin.class);
        } catch (IOException e) {
